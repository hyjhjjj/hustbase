...
RC OpenScan(RM_FileScan *rmFileScan,RM_FileHandle *fileHandle,int conNum,Con *conditions,ClientHint pinHint)//初始化扫描
{
	if(rmFileScan->bOpen){
		return RM_FSOPEN;
	}
